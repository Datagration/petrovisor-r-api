##### VORONOI GRID #####
context("Voronoi grid instanciation and conversion to list")

test_that("Voronoi grid instanciation and conversion works",{
...
##### VORONOI CELL #####
context("Voronoi cell instanciation and conversion to list")

test_that("Voronoi cell instanciation and conversion works",{
  c <- Point$new(x = 20,
                 y = 10)
