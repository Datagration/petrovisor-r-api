# Machine Learning with PetroVisor
...
The `MlTrainingService` provides machine learning capabilities within
PetroVisor. You can train models, make predictions, and manage ML
workflows directly from R. This guide covers the complete ML workflow
with tested examples.
...
3.  **Configure Training**: Set training options with scope and entity
    set
...
**Cause**: Trying to set preprocessing/custom training before training
options

**Solution**: Always call `set_training_options()` before other
configurations
...
- [`?MlTrainingService`](https://datagration.github.io/petrovisor-r-api/reference/MlTrainingService.md):
  ML training service documentation
